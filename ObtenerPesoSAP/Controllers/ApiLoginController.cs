...
namespace CYDSA_Sustentabilidad.Controllers
{
    public class ApiLoginController : Controller
    {
        ...
        public ActionResult TextoDesEncryptado(string texto)
        {
            ...
            if (existe)
            {
                var empresa = context.CPBascula.Where(x => x.CPIdUsuario == ususarios.CPIdUsuario && x.CPPlantaDefault == true).FirstOrDefault().CPIdEmpresa;
                Session["logeado"] = true;
                Session["idUsuario"] = ususarios.CPIdUsuario;
                Session["idPlantaDF"] = context.CPBascula.Where(x => x.CPIdUsuario == ususarios.CPIdUsuario && x.CPPlantaDefault == true).FirstOrDefault().CPIdEmpresa;
